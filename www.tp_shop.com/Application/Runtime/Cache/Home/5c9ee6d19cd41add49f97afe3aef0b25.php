	...
	<body>
		...
		<div class="panel center">
			...
			<ul>
				...
				<li>密码　<input type="text" name="password" placeholder="请输入密码"></input></li>
				<li>　　　<button class="submit" type="submit">登　录</button></li>
				<input type="checkbox" name="remember" value="1" style="width: 15px;height: 15px">记住我
				<li>
					<a href="">忘记密码？</a>　<a href="<?php echo U('User/register');?>">免费注册</a>
				</li>
			</ul>
			</form>

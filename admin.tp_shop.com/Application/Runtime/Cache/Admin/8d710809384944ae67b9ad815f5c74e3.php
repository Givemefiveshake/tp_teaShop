        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                已有图片
                    ...
                    <?php if(is_array($urls)): $i = 0; $__LIST__ = $urls;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$url): $mod = ($i % 2 );++$i;?><img src="<?php echo ($url["path"]); ?>" width="100px" height="100px">
                        <a href="<?php echo U('delete', array('id' => $url['id']));?>" class="btn btn-danger btn-xs deleteBtn">删除</a><?php endforeach; endif; else: echo "" ;endif; ?>

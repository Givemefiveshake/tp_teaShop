...
use \Admin\Logic\DbMysqlInterface;
...
class NestedSets {
	/**
	 * @access private
	 * @var \Admin\Logic\DbMysqlInterface an instance of Db class for manipulating with database
	 */
	private $Db;
	/**
	 * @access private
	 ...
	 *
	 * @access public
	 * @param \Admin\Logic\DbMysqlInterface $Db an instance of Db class for manipulating with database
